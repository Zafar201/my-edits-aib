            ...
            <Container className="ft-container">
                <Row>
                    ...
                    <Col className="ft-link" md={{ span: 2 }}>
                        ...
                        <Link activeClass="active" to="webinar" spy={true}>    <p className='footer-bold' >Events</p>  </Link>
                    ...
                    <Col className="ft-link" md={{ span: 2, }}>
                        ...
                        <Link activeClass="active" to="aislider" spy={true} > <p >Veterans GI Bill</p></Link>
